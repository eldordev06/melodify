    ...
    <header className="flex w-full flex-shrink-0 justify-between py-5 px-10">
      <div className="flex gap-5">
        ...
        {location.pathname == "/search" ? (
          <div className="bg-[#262626] border border-transparent w-[365px] rounded-full py-1.5 px-9 relative focus:border h-12 cursor-pointer hover:bg-[#2c2c2c] hover:border-[#717171]">
            <FiSearch
              size={16}
